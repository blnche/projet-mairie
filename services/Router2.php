...
class Router2
{
    ...
    private function splitRouteAndParameters(string $route): array
    {
        ...
        if (strlen($route) > 0) {
            ...
            if ($tab[0] === 'mairie') {
                ...
                $routeAndParams['route'] = $tab[0];
            } else if ($tab[0] === 'politiques-confidentialité') {
                $routeAndParams['route'] = $tab[0];
    ...
    public function checkRoute(string $route): void
    {
        ...
        } else if ($routeTab['route'] === 'mention-legales') {
            // TODO
        } else if ($routeTab['route'] === 'politiques-confidentialité') {
            // TODO
        } 
